<main style="background-position: center; background-repeat: no-repeat; background-attachment: fixed; background-size: cover; background-image: url('/assets/img/utt_fondo.jpeg')">

    <!-- Section -->
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center" style="">
                        ...
                        <form wire:submit.prevent="login" action="#" class="mt-4" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model="email" type="email" class="form-control"
                                        placeholder="ejemplo@correo.com" id="email" autofocus required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div><a href="{{ route('forgot-password') }}" class="small text-right">
