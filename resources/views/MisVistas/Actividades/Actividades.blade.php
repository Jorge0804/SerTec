<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="actividades/agregar" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        ...
        <tbody>
        @foreach($actividades as $el)
            <!-- Item -->
            <tr>
                <td>
                    <span class="fw-normal">{{$el->id_actividad}}</span>
                </td>
                <td>
                    <span class="fw-normal">{{$el->Descripcion}}</span>
                </td>
                <!--<td>
                    <div class="btn-group">
