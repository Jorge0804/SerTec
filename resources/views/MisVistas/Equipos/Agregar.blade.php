<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Agregar Equipo</h1>
            <p class="mb-0">En este segmento puede agregar un equipo</p>
        </div>
        <!--<div>
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card border-0 shadow components-section">
                <div class="card-body">
                    <div class="row mb-4">
                        <h1 class="h4">Información del equipo</h1>
                        <hr>
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-4">
                                <label for="email">Serie</label>
                                <input name="Serie" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-4">
                                ...
                                <input name="nombre" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                                <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-4">
                                <label for="email">Tipo de equipo</label>
                                <input name="Tipo_equipo" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                                <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
        ...
        <div class="col-12 mb-4">
            <button class="btn btn-info" type="submit">Agregar Equipo</button>
        </div>
    </div>
</form>
            ...
            <div class="modal-content bg-gradient-secondary">
                ...
                <div class="modal-body text-white">
                    <div class="py-3 text-center">
                        ...
                        <p>El equipo ha sido registrado con éxito</p>
                    </div>
                </div>
...
<script>
    ...
    function HacerRegistro(){
        $.post('/equipos/registrar', $('#data_form').serialize(), function(data){
