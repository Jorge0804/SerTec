<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Equipos</h2>
        <p class="mb-0">Vista general de todos los equipos</p>
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="equipos/agregar" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        <thead>
        <tr>
            <th class="border-gray-200">Serie</th>
        ...
        <tbody>
        @foreach($equipos as $el)
            <!-- Item -->
            <tr>
                <td>
                    <span class="fw-normal">{{$el->Serie}}</span>
                </td>
                <td>
                    <span class="fw-normal">{{$el->nombre}}</span>
                </td>
                <td><span class="fw-normal">{{$el->Tipo_equipo}}</span></td>
                <td><span class="fw-normal">{{$el->Descripcion}}</span></td>
                <!--<td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            <a class="dropdown-item rounded-top" href="#"><span class="fas fa-eye me-2"></span>Editar</a>
                        </div>
                    </div>
                </td>-->
            </tr>
