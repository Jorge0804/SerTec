<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Agregar Usuario</h1>
            <p class="mb-0">En este segmento puede agregar un usuario</p>
        </div>
        <!--<div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-4">
                                ...
                                <input name="apellidos" type="text" class="form-control" id="email" aria-describedby="emailHelp" required>
                                <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-4">
                                ...
                                <input name="password" type="password" class="form-control" id="email" aria-describedby="emailHelp" required>
                                <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="mb-4">
                                ...
                                <select name="id_rol" class="form-select" id="country" aria-label="Default select example" required>
            ...
            <div class="modal-content bg-gradient-secondary">
                ...
                <div class="modal-body text-white">
                    <div class="py-3 text-center">
                        ...
                        <h2 class="h4 modal-title my-3">Usuario registrado!</h2>
...
<script>
    ...
    function HacerRegistro(){
        $.post('/usuarios/registrar', $('#data_form').serialize(), function(data){
