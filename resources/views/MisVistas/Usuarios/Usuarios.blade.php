<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <p class="mb-0">Vista general de todos los usuarios</p>
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="usuarios/agregar" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        ...
        <tr>
            ...
            <th class="border-gray-200">Usuario (mail)</th>
        ...
        @foreach($usuarios as $el)
            ...
            <tr>
                <td>
                    <span class="fw-normal">{{$el->first_name}}</span>
                </td>
                <td>
                    <span class="fw-normal">{{$el->last_name}}</span>
                </td>
                <td><span class="fw-normal">{{$el->email}}</span></td>
                <td><span class="fw-normal">{{$el->rol->Tipo_rol}}</span></td>
                <!--<td>
                    <div class="btn-group">
