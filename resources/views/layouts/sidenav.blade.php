  ...
  <div class="sidebar-inner px-2 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        ...
        <div class="d-block">
          <h2 class="h5 mb-3">Hola, {{ $UsuarioProvider->first_name.' '.$UsuarioProvider->last_name }}</h2>
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="/dashboard" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon me-3">
            <img src="/assets/img/utt_logo.png" height="20" width="40" alt="Volt Logo">
          </span>
          <span class="mt-1 ms-1 sidebar-text" style="color: #009a7c">
            Servicios Tec.
          </span>
        </a>
      </li>
      ...
      <!--<li class="nav-item">
        ...
        @foreach($MenuProvider as $menu)
            <li class="nav-item">
                <a href="{{$menu->accion}}" class="nav-link">
          <span class="sidebar-icon"><i class="{{$menu->icono}}"></i></span>
                    <span class="sidebar-text">{{$menu->titulo}}</span>
                </a>
            </li>
        @endforeach
